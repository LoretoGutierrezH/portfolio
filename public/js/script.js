...
const translationDescription = document.querySelector('#translation-description');
const rorDescription = document.querySelector('#ror-description');
...
let basicsArray = [html5Skill, css3Skill, vanillaJavascriptSkill, reactSkill, firebaseSkill, figmaSkill, gitSkill, ubuntuAndTerminalSkill];
  ...
  skill.addEventListener('click', (event) => {
    ...
    switch (targetId) {
      case 'html5':
        ...
        basicsArray.forEach(skill => {
          skill.classList.replace('active-skill', 'inactive-skill');
        })
...
let notionsArray = [nodeSkill, expressSkill, mongoDbSkill, postgreSkill, rubySkill];
...
let interestArray = [backendSkill, backendJsSkill, cssFrameworksSkill];
